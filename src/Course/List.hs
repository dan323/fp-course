...
-- It is not possible to do something else as notReverse (x :. xs) = notReverse xs ++ (x :. Nil) by the property
-- and hence by induction it reverses fully.
